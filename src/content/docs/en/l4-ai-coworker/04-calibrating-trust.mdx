...
- **47% of enterprise AI users** made at least one major business decision based on hallucinated content ([Deloitte Global AI Survey, 2025](https://fourdots.com/business-impact-of-ai-hallucinations-rates-and-ranks))
- The [Harvard/BCG study](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4573321) showed: On tasks *outside* AI strengths, quality **dropped** — because consultants trusted the output without checking
...
Klarna's AI assistant handled the [equivalent work of 700 full-time agents](https://www.klarna.com/international/press/klarna-ai-assistant-handles-two-thirds-of-customer-service-chats-in-its-first-month/), automating two-thirds of all customer service chats. Resolution time dropped from 11 minutes to under 2 minutes. But quality dropped — generic responses, rising complaints. The CEO [publicly reversed course](https://www.entrepreneur.com/business-news/klarna-ceo-reverses-course-by-hiring-more-humans-not-ai/491396) and resumed hiring human agents.
...
- [Deloitte Global AI Survey (2025)](https://fourdots.com/business-impact-of-ai-hallucinations-rates-and-ranks) — 47% of enterprise AI users made business decisions based on hallucinated content
- [Dell'Acqua et al. (2023): "Navigating the Jagged Technological Frontier"](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4573321) — Harvard/BCG study on AI-assisted consulting quality
- [Klarna Press Release (Feb 2024)](https://www.klarna.com/international/press/klarna-ai-assistant-handles-two-thirds-of-customer-service-chats-in-its-first-month/) — AI assistant handling two-thirds of customer service chats
- [Klarna CEO Reverses Course (May 2025)](https://www.entrepreneur.com/business-news/klarna-ceo-reverses-course-by-hiring-more-humans-not-ai/491396) — Hiring human agents again after quality drop
