...
**The risk:** The AI might **make the number up**. This is exactly what <GlossaryTip term="Hallucination" definition="An AI response that is false or fabricated but sounds confident and convincing." />s are — confidently stated misinformation. Specific numbers, statistics, and source citations should **always** be independently verified.
