...
<LevelHero level={3} title="Kontext als Infrastruktur" description="Persistente Workspaces, System Prompts und die Tools, die deinen Kontext dauerhaft machen." />
<LessonIllustration src={l3Illustration.src} alt="Illustration: Persistenten Kontext aufbauen — den Job einmal erklÃ¤ren, nicht jeden Morgen" />
