...
<LevelHero level={4} title="AI als Coworker" description="Delegation, Trust Calibration und Compliance — der Schritt von Antworten zu eigenständigem Arbeiten." />
<LessonIllustration src={l4Illustration.src} alt="Illustration: Das Autonomie-Spektrum — von Chat zu Delegation" />
...
[Forschung der Harvard Business School](https://www.hbs.edu/faculty/Pages/item.aspx?num=64700) mit 758 BCG-Beratern (Dell'Acqua et al., 2023) hat zwei grundlegende Modi identifiziert, wie Menschen mit AI zusammenarbeiten:
...
Die [Harvard/BCG-Studie](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4573321) mit 758 Beratern und GPT-4 lieferte klare Ergebnisse:
...
- [Dell'Acqua et al. (2023): "Navigating the Jagged Technological Frontier"](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4573321) — Die Harvard/BCG-Studie mit 758 Beratern. Kernergebnis: +40% Qualität innerhalb der AI-Frontier, Qualitätsverlust ausserhalb.
- [HBS Faculty Page](https://www.hbs.edu/faculty/Pages/item.aspx?num=64700) — Offizielle Paper-Seite mit Abstract und Download
